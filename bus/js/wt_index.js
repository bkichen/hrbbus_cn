...
(
	function(package) {
		//cookie begin
		/**
		 * @description cookieæ“ä½œ
		 */
		var _cookie = {
			/** 
			 * @description è®¾ç½®cookie
			 * @function
			 * @param {String} name è¦è®¾ç½®çš„cookieçš„åå­—
			 * @param {String|Number} value è¦è®¾ç½®çš„cookieçš„å€¼
			 * @param {Object} option cookieçš„å‚æ•° 
			 *                 .expireDays {Number} è¿‡æœŸæ—¶é—´(å¤©æ•°) 
			 *                 .path {String} cookieè·¯å¾„ 
			 *                 .domain {String} cookieåŸŸ 
			 *                 .secure {Boolean} æ˜¯å¦å®‰å…¨
			 * @return {void}
			 */
			setCookie : function(name, value, option) {
				//ç”¨äºŽå­˜å‚¨èµ‹å€¼ç»™document.cookieçš„cookieæ ¼å¼å­—ç¬¦ä¸²
				var str = name + "=" + escape(value);
				if (option) {
					//å¦‚æžœè®¾ç½®äº†è¿‡æœŸæ—¶é—´
			...
			/** 
			 * @description è®¾ç½®mapbar cookieï¼Œä¿®æ”¹åŸŸä¸ºmapbar.comï¼Œå¦‚æžœç¼ºå°‘optionå‚æ•°ï¼Œé»˜è®¤ä¿å­˜30å¤©ï¼Œpathä¸º"/"
			 * @function
			 * @param {String} name è¦è®¾ç½®çš„cookieçš„åå­—
			 * @param {String|Number} value è¦è®¾ç½®çš„cookieçš„å€¼
			 * @param {Object} option cookieçš„å‚æ•° 
			...
			/** 
			 * @description å–å¾—cookieçš„å€¼
			 * @function
			 * @param {String} name è¦å–å¾—çš„cookieçš„åå­—
			 * @return {String} cookieçš„å€¼,æ²¡æœ‰æ‰¾åˆ°è¿”å›ž("")
			 */
			 ...
			 * @function
			 * @param {String} name è¦åˆ é™¤çš„cookieçš„åå­—
			 * @return {void}
			 */
		...
		//å°†_cookieæ³¨å†Œåˆ°package.cookie
		package.cookie = _cookie;
		//cookie end
		
		//request param begin
		/** 
		 * @description ä»Žurlä¸­å–å¾—è¯·æ±‚å‚æ•°
		 */
		var _request = {
			/** 
			 * @description ä»Žurlä¸­å–å¾—hashéƒ¨åˆ†çš„è¯·æ±‚å‚æ•°(#åŽ)
			 * @function
			 * @param {String} [newUrl="window.location.hash"] è¦å–å¾—å‚æ•°çš„url
			 * @return {Map} å‚æ•°å€¼å¯¹(key:value)
			 */
			...
			/** 
			 * @description ä»Žurlä¸­å–å¾—è¯·æ±‚å‚æ•°(?åŽ,#å‰)
			 * @function
			 * @param {String} [newUrl="window.location.href"] è¦å–å¾—å‚æ•°çš„url
			 * @return {Map} å‚æ•°å€¼å¯¹(key:value)
			 */
			...
			/** 
			 * @description ä»Žurlä¸­å–å¾—è¯·æ±‚å‚æ•°(?éƒ¨åˆ†å‚æ•°å°†è¦†ç›–#éƒ¨åˆ†å‚æ•°),æ›¿æ¢åŽŸæœ‰çš„initæ–¹æ³•
			 * @function
			 * @param {String} [newUrl="window.location.href"] è¦å–å¾—å‚æ•°çš„url
			 * @return {Map} å‚æ•°å€¼å¯¹(key:value)
			 */
			...
			/** 
			 * @description å°†ä¸€ä¸ªMapå¯¹è±¡è½¬æ¢ä¸ºurlçš„String
			 * @function
			 * @param {Map} requestObj è¦è½¬æ¢ä¸ºå­—ç¬¦ä¸²çš„Map
			 * @return {String} è½¬æ¢ä¸ºurlçš„String
			 */
		...
		//å°†_requestæ³¨å†Œåˆ°package.request
		...
		/** 
		 * @description æ‹‰å–è¿œç¨‹jsç±»
		 * @constructor æž„é€ å™¨
		 * @param {String} url jsæ–‡ä»¶çš„url
		 * @param {Map} [options={}] è¯·æ±‚å‚æ•°
		 *              .[id="scriptTemp"] {String} åˆ›å»ºscriptæ ‡ç­¾çš„idå±žæ€§
		 *              .[bCache=false] {Boolean} æ˜¯å¦å¯ç”¨ç¼“å­˜
		 *              .onfailure {Function} å¤±è´¥æ—¶æ‰§è¡Œçš„å‡½æ•°
		 *              .oncomplate {Function} æˆåŠŸæ—¶æ‰§è¡Œçš„å‡½æ•°
		 */
		...
		//å°†Transfer.Requestæ³¨å†Œåˆ°package.transfer.Request
		package.transfer = {
		...
		/** 
		 * @description å–å¾—è½¬æ¢åŽçš„utf8å­—ç¬¦ä¸²
		 * @function
		...
		//å°†getUtf8æ³¨å†Œåˆ°package.getUtf8
		package.getUtf8 = getUtf8;
		//get Utf-8 end
		
		//toHtmlStr begin
		/** 
		 * @description å°†å­—ç¬¦ä¸²è½¬æ¢æˆhtmlæ ¼å¼
		 * @function
		 * @param {String} str è¦è½¬æ¢çš„å­—ç¬¦ä¸²
		 * @return {String} è½¬æ¢åŽçš„å­—ç¬¦ä¸²
		 */
		...
		//å°†toHtmlStræ³¨å†Œåˆ°package.toHtmlStr
...
(function(package){
	jQuery.extend(package, {
		/*getWeather*/ iconInfoArray :[['æ™´','d00','n00','b0','0.png'],
					                     ['å¤šäº‘','d01','n01','b1','1.png'],
					                     ['é˜´','d02','n02','b2','2.png'],
										['é˜µé›¨','d03','n03','b3','3.png'],
										['é›·é˜µé›¨','d04','n04','b4','4.png'],
										['é›·é˜µé›¨ä¼´æœ‰å†°é›¹','d05','n05','b5','5.png'],
										['é›¨å¤¹é›ª','d06','n06','b6','6.png'],
										['å°é›¨','d07','n07','b7','7.png'],
										['ä¸­é›¨','d08','n08','b8','8.png'],
										['å¤§é›¨','d09','n09','b9','9.png'],
										['æš´é›¨','d10','n10','b10','10.png'],
										['å¤§æš´é›¨','d11','n11','b11','11.png'],
										['ç‰¹å¤§æš´é›¨','d12','n12','b12','12.png'],
										['é˜µé›ª','d13','n13','b13','13.png'],
										['å°é›ª','d14','n14','b14','14.png'],
										['ä¸­é›ª','d15','n15','b15','15.png'],
										['å¤§é›ª','d16','n16','b16','16.png'],
										['æš´é›ª','d17','n17','b17','17.png'],
										['é›¾	','d18','n18','b18','18.png'],
										['å†»é›¨','d19','n19','b19','19.png'],
										['æ²™å°˜æš´','d20','n20','b20','20.png'],
										['å°é›¨-ä¸­é›¨','d21','n21','b21','21.png'],
										['ä¸­é›¨-å¤§é›¨','d22','n22','b22','22.png'],
										['å¤§é›¨-æš´é›¨','d23','n23','b23','23.png'],
										['æš´é›¨-å¤§æš´é›¨','d24','n24','b24','24.png'],
										['å¤§æš´é›¨-ç‰¹å¤§æš´é›¨','d25','n25','b25','25.png'],
										['å°é›ª-ä¸­é›ª','d26','n26','b26','26.png'],
										['ä¸­é›ª-å¤§é›ª','d27','n27','b27','27.png'],
										['å¤§é›ª-æš´é›ª','d28','n28','b28','28.png'],
										['æµ®å°˜','d29','n29','b29','29.png'],
										['æ‰¬æ²™','d30','n30','b30','30.png'],
										['å¼ºæ²™å°˜æš´','d31','n31','b31','31.png']],
										localCity:null,
		...
		cbk : function () {
			if((typeof weather1)!="undefined"&&document.getElementById('weatherPanel')&& (typeof weather1.today)!="undefined" && (typeof weather1.tomorrow)!="undefined"){
				...
				var domArr =[];
				domArr.push('<a href="http://tianqi.mapbar.com/'+weather1.today.city.ename+'" target="_blank" style="text-decoration:none;" title="å¤©æ°”é¢„æŠ¥">');
				if((typeof weather1.today.city.name)!="undefined")
				{	
					/*domArr.push(weather1.today.city.name);
					domArr.push('</a>&nbsp;&nbsp;&nbsp;');
					domArr.push('<span class=chcity>[å…¶å®ƒåŸŽå¸‚]</span>');
					domArr.push('&nbsp;&nbsp;&nbsp;');*/
				}
...
//					domArr.push("'>&nbsp;<span style='color:red'>");
				...
				if((typeof weather1.today.smallNightImg)!="undefined" &&(typeof weather1.tomorrow.smallNightImg)!="undefined")
				{
					...
					domArr.push('Â°C</span>/<span style="color:blue;">');
					domArr.push(weather1.tomorrow.temperature);
					domArr.push('Â°C</span>');
					domArr.push('&nbsp;&nbsp;&nbsp;');
				}
...
(function(){
	...
	function initSearchbox()
	{
		...
		opts.demolist = false;
		opts.defaultdemo = {
				nls:"åŒ—äº¬å¸‚:é˜œæˆé—¨,ä¸Šæµ·å¸‚:é™†å®¶å˜´,å¹¿å·žå¸‚:ç«è½¦ç«™",
				bod:"åŒ—äº¬å¸‚:é˜œæˆé—¨;åŒ—äº¬å¸‚:åŒ—äº¬å¤§å­¦,ä¸Šæµ·å¸‚:å¾å®¶æ±‡;ä¸Šæµ·å¸‚:ä¸œæ–¹æ˜Žç ,å¹¿å·žå¸‚:ç«è½¦ç«™;å¹¿å·žå¸‚:èŠ³æ‘",
				nod:"å¹¿å·žå¸‚:åŒ—äº¬;å¹¿å·žå¸‚:ä¸Šæµ·,å±±ä¸œçœ:æ­¦æ±‰;å±±ä¸œçœ:å¹¿å·ž,åŒ—äº¬å¸‚:é˜œæˆé—¨;åŒ—äº¬å¸‚:æœ›äº¬",
				nnb:"åŒ—äº¬å¸‚:é˜œæˆé—¨:é…’åº—,ä¸Šæµ·å¸‚:é™†å®¶å˜´:è¶…å¸‚,åŒ—äº¬å¸‚:ç«è½¦ç«™:å®¾é¦†",
				nbl:"åŒ—äº¬å¸‚:300,ä¸Šæµ·å¸‚:1",
				nba:"åŒ—äº¬å¸‚:é˜œæˆé—¨,ä¸Šæµ·å¸‚:ç«™ç‚¹"
		};
		opts.demohint = "æŽ¨èï¼š,åŽ†å²ï¼š";
		opts.txtlen = {	ls : 5,//æœ¬åœ°æœå…³é”®å­—åœ¨åŠŸèƒ½ç¤ºä¾‹åŒºæ˜¾ç¤ºçš„å­—ç¬¦é•¿åº¦
				bl : 5,//å…¬äº¤çº¿è·¯å…³é”®å­—åœ¨åŠŸèƒ½ç¤ºä¾‹åŒºæ˜¾ç¤ºçš„å­—ç¬¦é•¿åº¦
				bz : 5,//å…¬äº¤ç«™ç‚¹å…³é”®å­—åœ¨åŠŸèƒ½ç¤ºä¾‹åŒºæ˜¾ç¤ºçš„å­—ç¬¦é•¿åº¦
				bo : 5,//å…¬äº¤æ¢ä¹˜èµ·ç‚¹å…³é”®å­—åœ¨åŠŸèƒ½ç¤ºä¾‹åŒºæ˜¾ç¤ºçš„å­—ç¬¦é•¿åº¦
				bd : 5,//å…¬äº¤æ¢ä¹˜ç»ˆç‚¹å…³é”®å­—åœ¨åŠŸèƒ½ç¤ºä¾‹åŒºæ˜¾ç¤ºçš„å­—ç¬¦é•¿åº¦
				no : 5,//é©¾è½¦å¯¼èˆªèµ·ç‚¹å…³é”®å­—åœ¨åŠŸèƒ½ç¤ºä¾‹åŒºæ˜¾ç¤ºçš„å­—ç¬¦é•¿åº¦
				nd : 5,//é©¾è½¦å¯¼èˆªç»ˆç‚¹å…³é”®å­—åœ¨åŠŸèƒ½ç¤ºä¾‹åŒºæ˜¾ç¤ºçš„å­—ç¬¦é•¿åº¦
				zc : 5,//å‘¨è¾¹æœä¸­å¿ƒç‚¹åœ¨åŠŸèƒ½ç¤ºä¾‹åŒºæ˜¾ç¤ºçš„å­—ç¬¦é•¿åº¦
				zk : 5//å‘¨è¾¹æœå…³é”®å­—åœ¨åŠŸèƒ½ç¤ºä¾‹åŒºæ˜¾ç¤ºçš„å­—ç¬¦é•¿åº¦
		};
		opts.demos = {
				ls : 1,// æœ¬åœ°æœç¤ºä¾‹ä¸ªæ•°
				bl : 2,// å…¬äº¤çº¿è·¯ç¤ºä¾‹ä¸ªæ•°
				bz : 3,// å…¬äº¤ç«™ç‚¹ç¤ºä¾‹ä¸ªæ•°
				bo : 4,// å…¬äº¤æ¢ä¹˜èµ·ç‚¹ç¤ºä¾‹ä¸ªæ•°
				no : 3,// é©¾è½¦å¯¼èˆªèµ·ç‚¹ç¤ºä¾‹ä¸ªæ•°
				zc : 2// å‘¨è¾¹æœç¤ºä¾‹ä¸ªæ•°
		};
		opts.hints = {
			ls : "è¾“å…¥è¦æœç´¢çš„åœ°ç‚¹",
			bl : "è¯·è¾“å…¥çº¿è·¯å",
			bz : "è¯·è¾“å…¥ç«™ç‚¹å",
			bo : "èµ·ç‚¹ï¼šç«™ç‚¹åæˆ–åœ°å",
			bd : "ç»ˆç‚¹ï¼šç«™ç‚¹åæˆ–åœ°å",
			no : "èµ·ç‚¹ï¼šåŸŽå¸‚åæˆ–åœ°å",
			nd : "ç»ˆç‚¹ï¼šåŸŽå¸‚åæˆ–åœ°å",
			zc : "è¯·è¾“å…¥åœ°ç‚¹",
			zk : "é…’åº—ã€é“¶è¡Œã€ATM..."
		};
...
//			sboxCity = cname;
//		}
//		var hcity = ["å…¨å›½","åŒ—äº¬","ä¸Šæµ·","å¹¿å·ž","æ·±åœ³","æˆéƒ½","é‡åº†","è¥¿å®‰","å—äº¬","æ²ˆé˜³","å¤©æ´¥"];
...
//		});
			  ...
			  case KQueryType.busearch:
				...
				case KQueryType.navsearch:
				{
					if(o.navorig && o.navdest && o.navorig.name && o.navdest.name)
					{
						u.push('ac=nav');
						u.push('&oc=');
						//u.push(encodeURIComponent(o.navorig.city == '' ? 'å…¨å›½' : o.navorig.city));
						...
						u.push('&oid=');
						u.push('&dc=');
						//u.push(encodeURIComponent(o.navdest.city == '' ? 'å…¨å›½' : o.navdest.city));
	...
	**/
	...
	{   
			...
			KEvent.bind(kcitylist, 'citychanged', function(e, w, c, p){
				if (c.name != _city.name) {
					...
					url.push('/');
					url.push(c.ename);
					//window.open(url.join(''));//è·³è½¬æ–°çª—å£
					setTimeout(function(){ 
						window.location.href = url.join(''); 
					},0); 
					//window.location.href = url.join('');//åœ¨å½“å‰é¡µè·³è½¬
	...
	/**
	* åˆå§‹åŒ–
	* @param tag Integer åˆå§‹åŒ–çš„å†…å®¹
	**/
	window.indexInitialize = function(tag)
	{
		switch(tag)
		{
			case 0:
			{
				getHeadLinks(); //å–å¾—é¡¶éƒ¨é“¾æŽ¥
				break;
			}
			case 1:
			{
				initSearchbox(); //åˆå§‹åŒ–æœç´¢æ¡†
				break;
			}
			case 2:
			{   
			  	initSearchbox(2); //åˆå§‹åŒ–ç¬¬äºŒä¸ªæœç´¢æ¡†
				break;
			}
			case 3:
			{
				initAccount(); //åˆå§‹åŒ–ç™»å½•ç»„ä»¶
				break;
			}
			case 4:
			{	
				initWeather(); //åˆå§‹åŒ–å¤©æ°”
				break;
			}
			case 5:
			{
				initCityList(); //åˆå§‹åŒ–åŸŽå¸‚è·³è½¬
				break;
			}
			case 6:
			{
				initTab(); //åˆå§‹åŒ–é€‰é¡¹å¡
				break;
			}
		}
	};
...
/*jQuery(document).ready(function(){
	$("#slider").easySlider({
		controlsShow: false,
           continuous: true,
           vertical: true, // æ˜¯å¦åž‚ç›´æ»šåŠ¨ï¼Œä¸ºtrueæ—¶åž‚ç›´æ»šåŠ¨ï¼Œä¸ºfalseä¸ºæ°´å¹³æ»šåŠ¨
           auto: true, // æ˜¯å¦æ»šåŠ¨
           speed: 5000, //æ»šåŠ¨é€Ÿåº¦	æ¯«ç§’	
           pause: 3000//æ»šåŠ¨é—´éš”æ—¶é—´ æ¯«ç§’
	});	
